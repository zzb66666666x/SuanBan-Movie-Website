...
$(document).ready(function () {
    ...
    $('#submit-task').click(function () {
        ...
        var myurl = ''
        var Movie_url = window.location.href
        Movie_url = Movie_url.split("/",5)
        Movie_url = Movie_url[4].split(".")[0]
        if (tID === 'Search Task'){
            myurl = '/video/rate/' +Movie_url+','+$('#task-modal').find('.form-control').val()
        }
        else if (tID === 'New Task'){
            myurl = '/create'
        }
        else{
            myurl = '/video/edit/' + $('#task-modal').find('.form-control').val()
        }
        ...
        $.ajax({
                type: 'GET',
                url: myurl,
                data: $('#task-modal').find('.form-control').val(),
        ...
        //     window.location.href = "/video/rate/" +  $('#task-modal').find('.form-control').val()
        // };
